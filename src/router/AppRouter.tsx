    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="device/:id" element={<DeviceDetails device={{} as any} onClose={() => {}} />} />
          <Route path="discovery/wizard" element={<DiscoveryWizard onComplete={() => {}} onCancel={() => {}} />} />
          <Route path="discovery/netbox" element={<NetBoxImporter onComplete={() => {}} onCancel={() => {}} />} />
          <Route path="topology/view" element={<TopologyScansView onDeviceSelect={() => {}} onSiteSelect={() => {}} scans={[]} />} />
          
          {/* Monitoring Direct Routes */}
          <Route path="monitoring/performance/:deviceId?" element={<PerformanceDashboard device={undefined} onClose={() => {}} />} />
          <Route path="monitoring/traffic" element={<NetworkTrafficAnalysis onClose={() => {}} />} />
          <Route path="monitoring/wireless" element={<WirelessNetworkMonitor onClose={() => {}} />} />
          <Route path="monitoring/applications" element={<ApplicationPerformanceMonitor onClose={() => {}} />} />
          <Route path="monitoring/cloud" element={<CloudResourcesMonitor onClose={() => {}} />} />
          <Route path="monitoring/logs" element={<LogManagement onClose={() => {}} />} />
          <Route path="monitoring/grafana" element={<GrafanaView onClose={() => {}} />} />
          
          {/* Management Direct Routes */}
          <Route path="management/configuration/:deviceId?" element={<ConfigurationManager onClose={() => {}} selectedDevice={undefined} />} />
          <Route path="management/backups" element={<BackupManagement onClose={() => {}} />} />
          <Route path="management/firmware" element={<FirmwareManagement onClose={() => {}} />} />
          <Route path="management/alerts" element={<AlertManagement onClose={() => {}} />} />
          <Route path="management/users" element={<UserList onClose={() => {}} />} />
          <Route path="management/roles" element={<UserRole onClose={() => {}} />} />
          <Route path="management/profile" element={<UserProfile onClose={() => {}} />} />
          
          {/* Settings Direct Routes */}
          <Route path="settings/credentials" element={<CredentialsManager onClose={() => {}} />} />
          <Route path="settings/grafana" element={<GrafanaConfig onClose={() => {}} />} />
          <Route path="settings/l2-services" element={<L2ServicesConfig onClose={() => {}} />} />
          ...
          <Route path="organization/manufacturers" element={<ManufacturersPage />} />
          <Route path="organization/racks" element={<RacksPage />} />
          <Route path="organization/device-roles" element={<DeviceRolesPage />} />
