...
export const NAVIGATION_ITEMS = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'netbox-import', label: 'Import from NetBox', path: ROUTES.DISCOVERY },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'locations', label: 'Locations', path: ROUTES.ORGANIZATION.LOCATIONS },
      { id: 'manufacturers', label: 'Manufacturers', path: ROUTES.ORGANIZATION.MANUFACTURERS },
      { id: 'racks', label: 'Racks', path: ROUTES.ORGANIZATION.RACKS },
      { id: 'device-roles', label: 'Device Roles', path: ROUTES.ORGANIZATION.DEVICE_ROLES },
    ],
  },
  {
    id: 'monitoring',
    ...
    icon: 'activity',
    children: [
      { id: 'performance', label: 'Performance', path: ROUTES.MONITORING.PERFORMANCE },
      { id: 'traffic', label: 'Traffic Analysis', path: ROUTES.MONITORING.TRAFFIC },
      { id: 'wireless', label: 'Wireless', path: ROUTES.MONITORING.WIRELESS },
      { id: 'applications', label: 'Applications', path: ROUTES.MONITORING.APPLICATIONS },
  ...
  },
  {
    ...
    icon: 'wrench',
    children: [
      { id: 'configuration', label: 'Configuration', path: ROUTES.MANAGEMENT.CONFIGURATION },
  ...
  },
  {
    ...
    icon: 'settings',
    children: [
      { id: 'credentials', label: 'Credentials', path: ROUTES.SETTINGS.CREDENTIALS },
      { id: 'grafana', label: 'Grafana', path: ROUTES.SETTINGS.GRAFANA },
      { id: 'l2-services', label: 'L2 Services', path: ROUTES.SETTINGS.L2_SERVICES },
    ],
  },
] as const;
